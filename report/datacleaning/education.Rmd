...
DT::datatable(edu_percholder_25_44, list(scrollX='400px',pageLength = 5,
...
DT::datatable(edu_per1000_18_24, list(scrollX='400px',pageLength = 5,
  lengthMenu = c(5, 10, 15, 20)))
```
...
DT::datatable(edu, list(scrollX='400px',pageLength = 5,
  lengthMenu = c(5, 10, 15, 20)))
```
