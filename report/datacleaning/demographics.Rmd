...
DT::datatable(st_est00int_race, options = list( scrollX='400px',pageLength = 5,
...
DT::datatable(st_est00int_agesex, options = list(scrollX='400px',pageLength = 5,
  lengthMenu = c(5, 10, 15, 20)))
```
...
DT::datatable(demographics, list(scrollX='400px',pageLength = 5,
  lengthMenu = c(5, 10, 15, 20)))
```
