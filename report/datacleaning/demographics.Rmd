...
We used 3 data-sets from the [United States Census Bureau's website](https://www.census.gov/).  
...
DT::datatable(st_est00int_race, options = list( scrollX='400px', scrollY='400px'))
```
...
DT::datatable(st_est00int_agesex, options = list(scrollX='400px', scrollY='400px'))
```
...
DT::datatable(demographics, list(scrollX='400px', scrollY='400px'))
```
