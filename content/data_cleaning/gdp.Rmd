...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
DT::datatable(GDP, list(scrollX='400px', scrollY='300px'), caption= "Raw Data - Dataset which gives us info on GDP, our variable of interest")
```
...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
DT::datatable(GDP_Cleaned, list(scrollX='400px', scrollY='300px'), caption= "Cleaned Data - Current-dollar GDP (millions of current dollars)")
```
