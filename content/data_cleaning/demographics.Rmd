...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
DT::datatable(st_est00int_race, caption = 'Raw data - Demographics, Race, 2000-2010', options = list( scrollX='400px', scrollY='400px'))
```
...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
DT::datatable(st_est00int_agesex, caption = 'Raw data - Demographics, Age & Sex, 2000-2010', options = list(scrollX='400px', scrollY='400px'))
```
...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
DT::datatable(st_est00int_agesex, caption = 'Raw data - Demographics, Race, Age & Sex, 2010-2019', options = list(scrollX='400px', scrollY='400px'))
```
...
(White=1, BlackAfricanAmerican=2, AmericanIndianAlaska=3, Asian=4, HawaiianPacificIslanders=5, Racegreaterthan1=6 and Total= for the dataset in years 2000-2010) and (Total=0, Male=1, Female=2).
...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
DT::datatable(demographics, list(scrollX='400px', scrollY='400px'), caption='Cleaned data - Demographics in US')
```
