...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
DT::datatable(head(raw_data_2004), caption = 'Raw data on Mental Health Expenditure per capita', options = list( scrollX='400px'))
```
